...
export const HeaderDropdown = ({ lang }) => (
  <Menu as="div" className="flex items-center lg:hidden">
    <MenuButton className="transition-colors duration-100 hover:text-primary-600 active:text-primary-500 dark:hover:text-primary-200 dark:active:text-primary-300">
      <Icon name="List" size={28} />
    </MenuButton>
    <MenuItems
      transition
      className="fixed inset-0 left-0 top-0 z-50 flex h-max w-full flex-col bg-primary-200 shadow-sm transition-all duration-200 data-[closed]:-translate-y-24 data-[closed]:opacity-0 data-[open]:opacity-100 dark:bg-primary-800"
    >
        ...
        >
          {({ close }) => (
            <>
              ...
              <Button
                onClick={close}
                className="transition-colors duration-75 hover:text-primary-700 active:text-primary-600 dark:hover:text-primary-200 dark:active:text-primary-300"
              >
